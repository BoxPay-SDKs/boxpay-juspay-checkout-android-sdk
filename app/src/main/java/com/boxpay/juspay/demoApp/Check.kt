...
class Check : AppCompatActivity() {
    ...
    private lateinit var fromTrainStation : String
    private lateinit var toTrainStation : String
    private lateinit var trainNumberName : String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        amount = bundle?.getString("amount","2304") ?: "2304"
        fromTrainStation = bundle?.getString("from","DELHI HAZRAT NIZAMUDDIN") ?: "DELHI HAZRAT NIZAMUDDIN"
        toTrainStation = bundle?.getString("to","MUMBAI BANDRA TERMINUS") ?: "MUMBAI BANDRA TERMINUS"
        trainNumberName = bundle?.getString("train","12910 - Garib Rath Express") ?: "12910 - Garib Rath Express"

        binding.textView6.text = "Generating Token Please wait..."
        hyperServiceHolder = com.boxpay.juspay.checkout.sdk.HyperServiceHolder(this)
    ...
    "language": "English"
        ...
        hyperServiceHolder.setBoxPayTextEnv(false)
        hyperServiceHolder.process(orderJson, true)
    }


    private fun createHyperPaymentsCallbackAdapter(): com.boxpay.juspay.checkout.sdk.`interface`.HyperPaymentsCallbackAdapter {
        return object : com.boxpay.juspay.checkout.sdk.`interface`.HyperPaymentsCallbackAdapter {
