package com.boxpay.juspay.checkout.sdk
...
import com.boxpay.juspay.checkout.sdk.`interface`.HyperPaymentsCallbackAdapter
...
class HyperServiceHolder(private val context: Context) {
    ...
    fun process(jsonObject: JSONObject, sandbox: Boolean = false) {
        ...
        val baseUrl = if (this.testEnv) "test-apis.boxpay.tech" else if (sandbox) "sandbox-apis.boxpay.tech" else "apis.boxpay.in"
        val url = "https://$baseUrl/v0/juspay/checkout/sessions"
